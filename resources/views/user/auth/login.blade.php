            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route($loginRoute) }}">
                        <img class="mb-4 d-flex justify-content-center mx-auto" src="{{asset('logo/bootstrap-logo.svg')}}" alt="" width="72" height="57">
                        <h1 class="h3 mb-3 fw-normal text-center">{{__('Please login')}}</h1>
                        @csrf
